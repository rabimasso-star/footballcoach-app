  ...
  return (
    <main className="page-shell">
      <div style={{ marginBottom: 20 }}>
        <Link href={`/teams/${teamId}`} style={{ color: "#334155", textDecoration: "none" }}>
          ← Back to team
        </Link>
      </div>
      ...
      <section className="card" style={{ padding: 28 }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <h1 className="section-title">Add a player</h1>

          <p className="section-subtitle">
            Add the player’s role, notes and attribute scores. These values can
            later guide AI-generated training sessions for the team.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "grid", gap: 24 }}>
          ...
          <div className="form-grid">
            <Field label="Player name" htmlFor="name">
              <input id="name" name="name" required placeholder="Example: Adam Ali" />
            </Field>
          ...
          <div className="form-grid">
            <Field label="Positions" htmlFor="positions">
              <input id="positions" name="positions" placeholder="Example: CM, LW" />
            </Field>

            <Field label="Dominant foot" htmlFor="dominantFoot">
              <select id="dominantFoot" name="dominantFoot" defaultValue="">
          ...
          <Field label="Coach notes" htmlFor="notes">
            <textarea
              ...
              name="notes"
              rows={4}
              placeholder="Example: Calm on the ball, needs support with scanning before receiving."
            />
          </Field>
          ...
          <section className="card" style={{ padding: 20, background: "#f8fafc" }}>
            ...
            <p style={{ color: "#64748b", marginBottom: 18 }}>
              Use a 1–10 scale. Start simple now; you can tune the model later.
            </p>
            ...
            <div className="form-grid" style={{ marginTop: 18 }}>
              <Field label="Main strengths" htmlFor="strengths">
                <textarea
                  ...
                  name="strengths"
                  rows={3}
                  placeholder="Example: Good first touch, brave in 1v1 situations."
                />
              </Field>
              ...
              <Field label="Main weaknesses" htmlFor="weaknesses">
                <textarea
                  ...
                  name="weaknesses"
                  rows={3}
                  placeholder="Example: Needs better defensive positioning and scanning."
                />
              </Field>
            </div>
          </section>
